...
setup(
    ...
    description="Prefect collection of tasks in order to work with Google Sheets",
    license="Apache License 2.0",
    author="Stefano Cascavilla",
    author_email="cascavilla1@gmail.com",
    keywords="prefect",
    url="https://github.com/stefanocascavilla/prefect-google-sheets",
    ...
    entry_points={
        "prefect.collections": [
            "prefect_google_sheets = prefect_google_sheets",
        ]
    },
    classifiers=[
